...
Rcpp_predict_sparse <- function(A, mask, w, nonneg, L1, L2, threads, mask_zeros) {
    .Call(`_RcppML_Rcpp_predict_sparse`, A, mask, w, nonneg, L1, L2, threads, mask_zeros)
}

Rcpp_predict_dense <- function(A_, mask, w, nonneg, L1, L2, threads, mask_zeros) {
    .Call(`_RcppML_Rcpp_predict_dense`, A_, mask, w, nonneg, L1, L2, threads, mask_zeros)
}
...
Rcpp_nmf_sparse <- function(A, mask, tol, maxit, verbose, nonneg, L1, L2, diag, threads, w_init, link_matrix_h, mask_zeros, link_h, sort_model) {
    .Call(`_RcppML_Rcpp_nmf_sparse`, A, mask, tol, maxit, verbose, nonneg, L1, L2, diag, threads, w_init, link_matrix_h, mask_zeros, link_h, sort_model)
}

Rcpp_nmf_dense <- function(A_, mask, tol, maxit, verbose, nonneg, L1, L2, diag, threads, w_init, link_matrix_h, mask_zeros, link_h, sort_model) {
    .Call(`_RcppML_Rcpp_nmf_dense`, A_, mask, tol, maxit, verbose, nonneg, L1, L2, diag, threads, w_init, link_matrix_h, mask_zeros, link_h, sort_model)
}
