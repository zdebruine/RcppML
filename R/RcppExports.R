...
Rcpp_projectW_sparse <- function(A, w, nonneg, L1, threads, mask_zeros, samples, features) {
    .Call('_RcppML_Rcpp_projectW_sparse', PACKAGE = 'RcppML', A, w, nonneg, L1, threads, mask_zeros, samples, features)
}

Rcpp_projectH_sparse <- function(A, h, nonneg, L1, threads, mask_zeros, samples, features) {
    .Call('_RcppML_Rcpp_projectH_sparse', PACKAGE = 'RcppML', A, h, nonneg, L1, threads, mask_zeros, samples, features)
}

Rcpp_projectW_dense <- function(A, w, nonneg, L1, threads, mask_zeros, samples, features) {
    .Call('_RcppML_Rcpp_projectW_dense', PACKAGE = 'RcppML', A, w, nonneg, L1, threads, mask_zeros, samples, features)
}

Rcpp_projectH_dense <- function(A, h, nonneg, L1, threads, mask_zeros, samples, features) {
    .Call('_RcppML_Rcpp_projectH_dense', PACKAGE = 'RcppML', A, h, nonneg, L1, threads, mask_zeros, samples, features)
}

Rcpp_mse_sparse <- function(A, w, d, h, mask_zeros, threads, samples, features) {
    .Call('_RcppML_Rcpp_mse_sparse', PACKAGE = 'RcppML', A, w, d, h, mask_zeros, threads, samples, features)
}

Rcpp_mse_dense <- function(A, w, d, h, mask_zeros, threads, samples, features) {
    .Call('_RcppML_Rcpp_mse_dense', PACKAGE = 'RcppML', A, w, d, h, mask_zeros, threads, samples, features)
}

Rcpp_nmf_sparse <- function(A, tol, maxit, verbose, nonneg, L1, diag, mask_zeros, threads, samples, features, w_init, update_in_place) {
