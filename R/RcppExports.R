...
Rcpp_projectW_sparse <- function(A, w, nonneg, L1, threads, mask_zeros) {
    .Call(`_RcppML_Rcpp_projectW_sparse`, A, w, nonneg, L1, threads, mask_zeros)
}

Rcpp_projectH_sparse <- function(A, h, nonneg, L1, threads) {
    .Call(`_RcppML_Rcpp_projectH_sparse`, A, h, nonneg, L1, threads)
}

Rcpp_projectW_dense <- function(A, w, nonneg, L1, threads) {
    .Call(`_RcppML_Rcpp_projectW_dense`, A, w, nonneg, L1, threads)
}

Rcpp_projectH_dense <- function(A, h, nonneg, L1, threads) {
    .Call(`_RcppML_Rcpp_projectH_dense`, A, h, nonneg, L1, threads)
}

Rcpp_mse_sparse <- function(A, w, d, h, threads, mask_zeros) {
    .Call(`_RcppML_Rcpp_mse_sparse`, A, w, d, h, threads, mask_zeros)
}

Rcpp_mse_dense <- function(A, w, d, h, threads) {
    .Call(`_RcppML_Rcpp_mse_dense`, A, w, d, h, threads)
}

Rcpp_nmf_sparse <- function(A, tol, maxit, verbose, nonneg, L1, diag, threads, w_init, mask_zeros) {
    .Call(`_RcppML_Rcpp_nmf_sparse`, A, tol, maxit, verbose, nonneg, L1, diag, threads, w_init, mask_zeros)
}

Rcpp_nmf_dense <- function(A_, tol, maxit, verbose, nonneg, L1, diag, threads, w_init) {
    .Call(`_RcppML_Rcpp_nmf_dense`, A_, tol, maxit, verbose, nonneg, L1, diag, threads, w_init)
}
...
nnls <- function(a, b, cd_maxit = 100L, cd_tol = 1e-8, fast_nnls = FALSE, L1 = 0) {
    .Call(`_RcppML_nnls`, a, b, cd_maxit, cd_tol, fast_nnls, L1)
}
