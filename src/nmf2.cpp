...
wdh2model c_nmf2_sparse(
  ...
  return wdh2model{w.transpose(), d, h, tol_, it};
}

wdh2model c_nmf2_dense(
...
Rcpp::List Rcpp_nmf2_sparse(
  ...
  std::vector<double> random_values = getRandomValues(samples.size() * 2, seed);
