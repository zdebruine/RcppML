#!/usr/bin/env python3
"""Overwrite R/streampress.R with the complete updated version.
Run on a compute node to bypass NFS caching."""

import os

path = "/mnt/home/debruinz/RcppML-2/R/streampress.R"

content = r'''#' @title StreamPress I/O: Read, Write, and Inspect Compressed Matrices
#'
#' @description
