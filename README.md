...
Once installed and loaded, RcppML C++ headers defining classes (i.e. "SparseMatrix", "NMF", "Cluster") can be loaded can be used in any R package using `#include <RcppML.hpp>`. 
