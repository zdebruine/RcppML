...
// solve for 'h' given sparse 'A'
void project(RcppML::SparseMatrix& A, const Eigen::MatrixXd& w, Eigen::MatrixXd& h, const bool nonneg,
...
// solve for 'h' given dense 'A'
void project(const Eigen::MatrixXd& A, const Eigen::MatrixXd& w, Eigen::MatrixXd& h, const bool nonneg,
             const double L1, const unsigned int threads) {
...
// solve for 'w' given sparse 'A'
void projectInPlace(RcppML::SparseMatrix& A, const Eigen::MatrixXd& h, Eigen::MatrixXd& w, const bool nonneg,
                    const double L1, const unsigned int threads) {
...
// solve for 'w' given dense 'A'
void projectInPlace(const Eigen::MatrixXd& A, const Eigen::MatrixXd& h, Eigen::MatrixXd& w, const bool nonneg,
                    const double L1, const unsigned int threads) {
...
// solve for 'h' given sparse 'A' while masking zeros
void project_mask_zeros(RcppML::SparseMatrix& A, const Eigen::MatrixXd& w, Eigen::MatrixXd& h,
                        const bool nonneg, const double L1) {
