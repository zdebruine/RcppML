...
# Phase 0 safety net — predict() for svd_pca objects.
# =============================================================================
...
# ===========================================================================
# predict.svd_pca — expected-fail skeleton until implemented
# ===========================================================================
...
test_that("svd_pca model stores row_means when centered", {
  s <- pca(A_iris, k = 3, method = "deflation", seed = 1, maxit = 200, tol = 1e-8,
           test_fraction = 0)
...
test_that("svd_pca reconstruction inverts projection (PCA)", {
...
test_that("svd_pca reconstruction inverts projection (SVD, no centering)", {
  set.seed(99)
