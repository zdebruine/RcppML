test_that("Testing RcppML::nmf", {
  ...
  model_bad <- RcppML::nmf(A, 5, maxit = 2, tol = 1e-10)
  model_good <- RcppML::nmf(A, 5, maxit = 20, tol = 1e-10)
  model_bad_mse <- RcppML::mse(A, model_bad$w, model_bad$d, model_bad$h)
  model_good_mse <- RcppML::mse(A, model_good$w, model_good$d, model_good$h)
  ...
  model <- RcppML::nmf(sim, 5, diag = F, seed = 123, tol = 1e-6)
  model2 <- RcppML::nmf(sim, 5, diag = T, seed = 123, tol = 1e-6)
