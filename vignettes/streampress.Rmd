...
The `pbmc3k` dataset ships as StreamPress-compressed raw bytes, demonstrating how
SPZ enables shipping large datasets within CRAN's tarball size limits.
...
reads from `.spz`, and the [NMF Deep Dive](nmf-deep-dive.html) vignette for
